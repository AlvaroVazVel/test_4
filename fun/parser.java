...
/** CUP v0.11b 20140611 (SVN rev 31) generated parser.
  * @version Wed Nov 30 14:44:50 CET 2022
  */
      ...
      switch (CUP$parser$act_num)
		...
		fun.Absyn.Exp p_4 = (fun.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ...
		 RESULT = new fun.Absyn.ListDef(); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("ListDef",3, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		fun.Absyn.Def p_2 = (fun.Absyn.Def)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 ...
		 RESULT = new fun.Absyn.ListIdent(); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("ListIdent",4, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
